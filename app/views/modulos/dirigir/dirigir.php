...
<body class="bg-gradient-to-br from-gray-50 to-purple-50">
    ...
    <main class="ml-0 md:ml-72 p-4 md:p-8">
        ...
        if (isset($dashboard)) {
            echo "<!-- DEBUG: dashboard tipo: " . gettype($dashboard) . " -->\n";
            echo "<!-- DEBUG: dashboard es array? " . (is_array($dashboard) ? 'YES' : 'NO') . " -->\n";
            if (is_array($dashboard)) {
                echo "<!-- DEBUG: dashboard keys: " . htmlspecialchars(implode(', ', array_keys($dashboard))) . " -->\n";
                echo "<!-- DEBUG: dashboard contenido (resumen): " . htmlspecialchars(json_encode(array_map(function($item) {
                    if (is_array($item)) {
                        return is_array($item) ? 'Array(' . count($item) . ' items)' : $item;
                    }
                    return gettype($item);
                }, $dashboard))) . " -->\n";
            }
        } else {
            echo "<!-- DEBUG: dashboard is NOT SET or NULL -->\n";
        }
        ?>
        ...
        <div class="glass-card rounded-2xl p-6">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900 mb-2">Dashboard de Dirección</h2>
                    <p class="text-gray-600">Vista general del rendimiento y actividades del equipo</p>
                </div>
            ...
            <?php if (isset($dashboard) && is_array($dashboard) && !empty($dashboard)): ?>
            
            <!-- Estadísticas principales -->
            <?php if (isset($dashboard['estadisticas_tareas'])): ?>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-gradient-to-r from-purple-50 to-purple-100 p-6 rounded-2xl hover-lift">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-3xl font-bold text-gray-900"><?php echo $dashboard['estadisticas_tareas']['total_tareas'] ?? 0; ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-green-50 to-emerald-100 p-6 rounded-2xl hover-lift">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-3xl font-bold text-green-600"><?php echo $dashboard['estadisticas_tareas']['tareas_completadas'] ?? 0; ?></div>
                        </div>
                    </div>
                </div>
                
                <div class="bg-gradient-to-r from-yellow-50 to-amber-100 p-6 rounded-2xl hover-lift">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-3xl font-bold text-yellow-600"><?php echo $dashboard['estadisticas_tareas']['tareas_en_progreso'] ?? 0; ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-red-50 to-rose-100 p-6 rounded-2xl hover-lift">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-3xl font-bold text-red-600"><?php echo $dashboard['estadisticas_tareas']['tareas_vencidas'] ?? 0; ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div class="bg-white p-6 rounded-2xl border border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Eficiencia del Equipo</h3>
                    <div class="space-y-6">
                        <div>
                            <div class="flex justify-between text-sm text-gray-600 mb-1">
                                <span>Porcentaje Completado Promedio</span>
                                <span class="font-bold <?php echo ($dashboard['estadisticas_tareas']['porcentaje_promedio'] ?? 0) >= 80 ? 'text-green-600' : (($dashboard['estadisticas_tareas']['porcentaje_promedio'] ?? 0) >= 50 ? 'text-yellow-600' : 'text-red-600'); ?>">
                                    <?php echo number_format($dashboard['estadisticas_tareas']['porcentaje_promedio'] ?? 0, 1); ?>%
                                </span>
                            </div>
                            <div class="progress-bar">
                                <div class="progress-fill bg-gradient-to-r from-green-400 to-emerald-500" 
                                    style="width: <?php echo min(100, max(0, $dashboard['estadisticas_tareas']['porcentaje_promedio'] ?? 0)); ?>%"></div>
                            </div>
                        </div>
                        
                        <div>
                            <div class="flex justify-between text-sm text-gray-600 mb-1">
                                <span>Eficiencia en Horas</span>
                                <span class="font-bold <?php echo ($dashboard['estadisticas_tareas']['eficiencia_horas'] ?? 0) >= 100 ? 'text-green-600' : (($dashboard['estadisticas_tareas']['eficiencia_horas'] ?? 0) >= 80 ? 'text-yellow-600' : 'text-red-600'); ?>">
                                    <?php echo number_format($dashboard['estadisticas_tareas']['eficiencia_horas'] ?? 0, 1); ?>%
                                </span>
                            </div>
                            <div class="progress-bar">
                                <div class="progress-fill bg-gradient-to-r from-blue-400 to-cyan-500" 
                                    style="width: <?php echo min(100, max(0, $dashboard['estadisticas_tareas']['eficiencia_horas'] ?? 0)); ?>%"></div>
                            </div>
                            <div class="text-xs text-gray-500 mt-1">
                                <?php echo number_format($dashboard['estadisticas_tareas']['horas_reales_total'] ?? 0, 1); ?>h reales / 
                                <?php echo number_format($dashboard['estadisticas_tareas']['horas_estimadas_total'] ?? 0, 1); ?>h estimadas
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php if (isset($dashboard['tareas_proximas']) && !empty($dashboard['tareas_proximas'])): ?>
            <div class="bg-gradient-to-r from-orange-50 to-amber-50 p-6 rounded-2xl mb-8">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-lg font-semibold text-gray-900">Tareas Próximas a Vencer (7 días)</h3>
                    <span class="px-3 py-1 bg-gradient-to-r from-orange-100 to-amber-100 text-orange-700 rounded-full text-sm font-medium">
                        <?php echo count($dashboard['tareas_proximas']); ?> tareas
                    </span>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php foreach(array_slice($dashboard['tareas_proximas'], 0, 6) as $tarea): ?>
                    <div class="bg-white p-4 rounded-xl border border-orange-200 hover-lift">
                        <div class="flex justify-between items-start mb-3">
                            <div class="flex-1">
                                <div class="font-medium text-gray-900 truncate"><?php echo htmlspecialchars(substr($tarea['descripcion_tarea'] ?? 'Sin nombre', 0, 50)); ?></div>
                                <div class="text-sm text-gray-600 mt-1"><?php echo htmlspecialchars($tarea['proyecto_nombre'] ?? ''); ?></div>
                            </div>
                            <span class="status-badge <?php echo ($tarea['dias_restantes'] ?? 0) < 0 ? 'badge-atrasada' : 'badge-alta'; ?> ml-2">
                                <?php 
                                $dias = $tarea['dias_restantes'] ?? 0;
                                if ($dias < 0) {
                                    echo abs($dias) . ' días retraso';
                                } elseif ($dias == 0) {
                                    echo 'Hoy';
                                } else {
                                    echo $dias . ' días';
                        ...
                        <div class="flex justify-between items-center">
                            <div class="text-xs text-gray-500">
                                Vence: <?php echo isset($tarea['fecha_limite']) ? date('d/m/Y', strtotime($tarea['fecha_limite'])) : 'N/A'; ?>
                            </div>
                ...
                <?php if (count($dashboard['tareas_proximas']) > 6): ?>
                <div class="text-center mt-4">
                    <a href="?accion=tareas&estado=atrasada" class="text-orange-600 hover:text-orange-800 text-sm font-medium">
                        Ver todas las tareas próximas a vencer →
                    </a>
                </div>
                <?php endif; ?>
            </div>
            ...
            <?php if (isset($dashboard['actividades_recientes']) && !empty($dashboard['actividades_recientes'])): ?>
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden mb-8">
                ...
                <div class="divide-y divide-gray-200">
                    <?php foreach(array_slice($dashboard['actividades_recientes'], 0, 5) as $actividad): ?>
                    <div class="p-4 hover:bg-gray-50">
                        <div class="flex items-start gap-3">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 
                                <?php echo $actividad['tipo'] == 'tarea' ? 'bg-blue-100 text-blue-600' : 'bg-purple-100 text-purple-600'; ?>">
                                <i class="fas <?php echo $actividad['tipo'] == 'tarea' ? 'fa-tasks' : 'fa-comments'; ?>"></i>
                            </div>
                            <div class="flex-1">
                                <div class="font-medium text-gray-900"><?php echo htmlspecialchars($actividad['descripcion'] ?? ''); ?></div>
                                <div class="text-sm text-gray-600 mt-1">
                                    <span class="font-medium"><?php echo htmlspecialchars($actividad['usuario_nombre'] ?? ''); ?></span> · 
                                    <span><?php echo htmlspecialchars($actividad['proyecto_nombre'] ?? ''); ?></span> · 
                                    <span><?php echo isset($actividad['fecha']) ? date('d/m/Y H:i', strtotime($actividad['fecha'])) : ''; ?></span>
                                </div>
                            </div>
                            <?php if ($actividad['tipo'] == 'tarea'): ?>
                            <span class="status-badge <?php echo 'badge-' . ($actividad['estado'] ?? 'pendiente'); ?>">
                                <?php echo ucfirst(str_replace('_', ' ', $actividad['estado'] ?? 'pendiente')); ?>
                            </span>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="p-4 border-t border-gray-200 text-center">
                    <a href="?accion=tareas" class="text-purple-600 hover:text-purple-800 text-sm font-medium">
            ...
            <!-- Carga de trabajo -->
            <?php if (isset($dashboard['carga_trabajo']) && !empty($dashboard['carga_trabajo'])): ?>
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-2xl">
                <h3 class="text-lg font-semibold text-gray-900 mb-6">Distribución de Carga de Trabajo</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php foreach(array_slice($dashboard['carga_trabajo'], 0, 6) as $recurso): ?>
                    <div class="bg-white p-4 rounded-xl border border-gray-200 hover-lift">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold">
                                <?php echo isset($recurso['recurso_nombre']) ? strtoupper(substr($recurso['recurso_nombre'], 0, 1)) : 'R'; ?>
                            </div>
                            <div>
                                <div class="font-medium text-gray-900"><?php echo htmlspecialchars($recurso['recurso_nombre'] ?? ''); ?></div>
                                <div class="text-sm text-gray-600"><?php echo htmlspecialchars($recurso['rol_proyecto'] ?? ''); ?></div>
                            </div>
                        </div>
                        <div class="space-y-3">
                            <div>
                                <div class="text-xs text-gray-500 mb-1">Tareas Asignadas</div>
                                <div class="text-lg font-bold text-gray-900"><?php echo $recurso['total_tareas'] ?? 0; ?></div>
                            </div>
                            <div>
                            ...
                            <div class="text-xs text-gray-500">
                                <?php echo number_format($recurso['horas_estimadas'] ?? 0, 1); ?>h estimadas
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
                <?php if (count($dashboard['carga_trabajo']) > 6): ?>
                <div class="text-center mt-6">
                    <a href="?accion=reportes" class="text-gray-700 hover:text-gray-900 text-sm font-medium">
                        Ver informe completo de carga de trabajo →
                    </a>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="text-center py-16">
                <div class="w-24 h-24 mx-auto bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center mb-6">
                    <i class="fas fa-tachometer-alt text-4xl text-gray-400"></i>
                </div>
                <h3 class="text-xl font-semibold text-gray-700 mb-3">No hay datos disponibles</h3>
                <p class="text-gray-500 mb-6 max-w-md mx-auto">
                    El dashboard se mostrará cuando haya tareas y comunicaciones en el sistema.
                    <?php if ($usuario_rol != 'miembro_equipo'): ?>
                    Comienza creando tareas y enviando comunicaciones al equipo.
                    <?php endif; ?>
                </p>
            ...
            if (estadoCtx) {
                new Chart(estadoCtx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [
                                <?php echo $dashboard['estadisticas_tareas']['tareas_pendientes'] ?? 0; ?>,
                                <?php echo $dashboard['estadisticas_tareas']['tareas_en_progreso'] ?? 0; ?>,
                                <?php echo $dashboard['estadisticas_tareas']['tareas_completadas'] ?? 0; ?>,
                                <?php echo $dashboard['estadisticas_tareas']['tareas_vencidas'] ?? 0; ?>,
                                <?php echo $dashboard['estadisticas_tareas']['tareas_en_revision'] ?? 0; ?>
                            ],
                            backgroundColor: [
                                '#fbd38d', // amarillo para pendientes
                                '#bee3f8', // azul para en progreso
                                '#c6f6d5', // verde para completadas
                                '#fed7d7', // rojo para atrasadas
                                '#e9d8fd'  // violeta para revisión
                            ],
                            borderWidth: 2,
                            borderColor: '#ffffff'
                        }]
            ...
            <div class="mb-6 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl p-4 md:p-6">
                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <select name="orden" class="form-input">
                        ...
                        <tr class="table-row-hover">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col gap-2">
                                    ...
                                    <?php if ($usuario_rol != 'miembro_equipo' || (isset($tarea['usuario_id']) && $tarea['usuario_id'] == $usuario_id)): ?>
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <div class="font-medium <?php echo ($tarea['proyecto_estado'] ?? '') == 'en_ejecucion' ? 'text-green-600' : 'text-gray-600'; ?>">
                                    <?php 
                                    $estado_proyecto = $tarea['proyecto_estado'] ?? 'desconocido';
                                    if ($estado_proyecto) {
                                        echo ucfirst(str_replace('_', ' ', $estado_proyecto));
                                    } else {
                                        echo 'Desconocido';
                                    }
                                    ?>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    class="bg-gradient-to-r from-yellow-500 to-orange-500 hover:opacity-90 text-white px-5 py-2.5 rounded-xl font-medium flex items-center gap-2 hover-lift shadow-lg">
                        ...
                        No leídas (<?php echo count($comunicaciones_no_leidas); ?>)
                    </a>
                    <?php endif; ?>
                </div>
            </div>
                        ...
                        <div class="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                            <div class="flex-1">
                                ...
                                <div class="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                                    ...
                                    <?php if (!empty($com['receptor_nombre'])): ?>
                                    <div class="flex items-center">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span><?php echo htmlspecialchars($com['fecha_envio_formatted'] ?? date('d/m/Y H:i', strtotime($com['fecha_envio'] ?? 'now'))); ?></span>
                                    </div>
                                    <div class="flex items-center">
                            ...
                            <div class="flex gap-2">
                                ...
                                <?php if (($usuario_rol == 'administrador') || (isset($com['emisor_id']) && $com['emisor_id'] == $usuario_id)): ?>
                                ...
                                <?php endif; ?>
                                <?php if (!$com['leido'] && (empty($com['receptor_id']) || $com['receptor_id'] == $usuario_id)): ?>
            ...
            <div class="text-center py-16">
                ...
                <p class="text-gray-500 mb-6 max-w-md mx-auto">
                    ...
                    if (isset($_GET['leido']) && $_GET['leido'] == '0') {
                        echo 'No tienes comunicaciones no leídas.';
                    } else {
                        echo 'Comienza enviando una comunicación al equipo';
                    }
                    ?>
                </p>
                <a href="?accion=crear_comunicacion" 
        ...
        <div class="glass-card rounded-2xl p-6">
            ...
            <form method="POST" class="space-y-6">
                                ...
                                <?php foreach ($proyectos as $proyecto): ?>
                                    <option value="<?php echo htmlspecialchars($proyecto['id'] ?? ''); ?>"
                                        ...
                                        if (isset($datos_form['proyecto_id']) && $datos_form['proyecto_id'] == $proyecto['id']) {
                                            $selected = true;
                                        } elseif (isset($comunicacion['proyecto_id']) && $comunicacion['proyecto_id'] == $proyecto['id']) {
                                            $selected = true;
                                        }
                            ...
                            <?php if (isset($tipos)): ?>
                                <?php foreach ($tipos as $tipo): ?>
                                    <option value="<?php echo htmlspecialchars($tipo); ?>"
                                        <?php 
                                        $selected = false;
                                        if (isset($datos_form['tipo']) && $datos_form['tipo'] == $tipo) {
                                            $selected = true;
                                        } elseif (isset($comunicacion['tipo']) && $comunicacion['tipo'] == $tipo) {
                                            $selected = true;
                                        }
                                        echo $selected ? 'selected' : '';
                                        ?>>
                            ...
                            <?php if (isset($usuarios)): ?>
                                <?php foreach ($usuarios as $usuario): ?>
                                    ...
                                    <option value="<?php echo htmlspecialchars($usuario['id'] ?? ''); ?>"
                                        <?php 
                                        $selected = false;
                                        if (isset($datos_form['receptor_id']) && $datos_form['receptor_id'] == $usuario['id']) {
                                            $selected = true;
                                        } elseif (isset($comunicacion['receptor_id']) && $comunicacion['receptor_id'] == $usuario['id']) {
                                            $selected = true;
                                        }
                                        echo $selected ? 'selected' : '';
                                        ?>>
                            ...
                            <?php if (isset($prioridades)): ?>
                                <?php foreach ($prioridades as $prioridad): ?>
                                    <option value="<?php echo htmlspecialchars($prioridad); ?>"
                                        <?php 
                                        $selected = false;
                                        if (isset($datos_form['prioridad']) && $datos_form['prioridad'] == $prioridad) {
                                            $selected = true;
                                        } elseif (isset($comunicacion['prioridad']) && $comunicacion['prioridad'] == $prioridad) {
                                            $selected = true;
                                        }
                                        echo $selected ? 'selected' : '';
                                        ?>>
                ...
                <div class="flex flex-wrap gap-3 pt-6 border-t border-gray-200">
                    ...
                    <?php if (isset($comunicacion['id']) && ($usuario_rol == 'administrador' || (isset($comunicacion['emisor_id']) && $comunicacion['emisor_id'] == $usuario_id))): ?>
        ...
        <div class="glass-card rounded-2xl p-6">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <?php if (($usuario_rol == 'administrador') || (isset($comunicacion['emisor_id']) && $comunicacion['emisor_id'] == $usuario_id)): ?>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-2xl mb-6">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                    <div>
                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            ...
                            <?php if (!$comunicacion['leido'] && (empty($comunicacion['receptor_id']) || $comunicacion['receptor_id'] == $usuario_id)): ?>
                    ...
                    <div class="text-right">
                        ...
                        <div class="font-medium text-gray-900">
                            <?php echo htmlspecialchars($comunicacion['fecha_envio_formatted'] ?? date('d/m/Y H:i', strtotime($comunicacion['fecha_envio'] ?? 'now'))); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                    ...
                    <div class="bg-white p-4 rounded-xl">
                        ...
                        <div class="flex items-center gap-3">
                            <?php if (!empty($comunicacion['receptor_nombre'])): ?>
    ...
    <script>
        // Scripts globales (igual que antes)
        document.addEventListener('DOMContentLoaded', function() {
